...
def test_config(
    ...
    assert mock_ssh_tunnel_forwarder.call_args.kwargs["ssh_address_or_host"] == (
        tunnel_host,
        tunnel_port,
    )
    assert mock_ssh_tunnel_forwarder.call_args.kwargs["ssh_username"] == tunnel_user
    assert mock_ssh_tunnel_forwarder.call_args.kwargs["ssh_password"] == tunnel_passwd
    mock_ssh_tunnel_forwarder.reset_mock()
